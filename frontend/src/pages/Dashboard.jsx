...
const fetchDashboardData = async () => {
  ...
  try {
    ...
    setStats({
  totalRecipes:
    recipesRes.data?.data?.stats?.total_recipes ??
    recipesRes.data?.data?.total_recipes ??
    0,

  pantryItems:
    pantryRes.data?.data?.stats?.total_items ??
    pantryRes.data?.data?.total_items ??
    0,

  mealsThisWeek:
    mealPlanRes.data?.data?.stats?.this_week_count ??
    mealPlanRes.data?.data?.this_week_count ??
    0,
});
